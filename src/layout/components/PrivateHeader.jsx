    ...
    <>
      <nav className="flex items-center justify-between flex-wrap bg-cyan-600 p-6">
        ...
        <div className="w-full block flex-grow sm:flex items-center sm:w-auto gap-2">
          ...
          <div>
            <button className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 sm:mt-0">
              <FontAwesomeIcon icon={faUser} />{" "}
              {" " + auth.name.first + " " + auth.name.last}{" "}
              <FontAwesomeIcon icon={faAngleDown} />
            </button>
            <div className="fixed text-sm px-4 py-2 bg-teal-300 leading-none text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 sm:mt-0 z-10">
