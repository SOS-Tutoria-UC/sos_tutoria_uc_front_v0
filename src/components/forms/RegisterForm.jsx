...
//Constantes
import { Q01OPTIONS, Q03AOPTIONS, Q03BOPTIONS, Q09OPTIONS, Q03OPTIONS, SKILLS } from '../../utils/constantes';
...
const RegisterForm = () => {
  ...
  const [ stateq03b, Selectq03b ] = useSelect('q03b', "Q03.b ¿Cuál es tu carrera?", Q03OPTIONS, "Seleccione una carrera");
  const [ stateq03a, Selectq03a ] = useSelect('q03a',"Q03.a ¿Cuál es tu campus?", Q03AOPTIONS, "Seleccione un campus");
  const [ stateq04, Selectq04 ] = useSelect('q04', "Q04 ¿Cuál es su programa de grado este año? (lo que te identifique mejor)", Q03BOPTIONS, "Seleccione un programa");
  ...
  const handleSubmit = (e) => {
    ...
    if(stateq04 === ''){
      modal('Campos obligatorios!', 'Completar el campo "PROGRAMA DE GRADO"', 'warning');
      return;
    }
  ...
  return (
    ...
    <div className='p-5 mt-10 mb-5 bg-blue-50'>
          ...
          <p className="mt-1 max-w-2xl text-sm text-gray-500">
            ...
            <span className='font-bold'>La contraseña debe tener mínimo 6 carateres.</span>
          </p>
       </div>
      ...
      <div className="form-group mb-6">
            <input type="text" className="form-control block
              ...
              onChange={(e) => handleSetStudentData({...personalInfo, nombre:e.target.value})}
              />
          </div>
          <div className="form-group mb-6">
            <input type="text" className="form-control block
              ...
              onChange={(e) => handleSetStudentData({...personalInfo, apellido:e.target.value})}/>
          </div>
          <div className="form-group mb-6">
            <input type="email" className="form-control block
              ...
              onChange={(e) => handleSetStudentData({...personalInfo, email:e.target.value})}/>
          </div>
          <div className="form-group mb-6">
          ...
          <div className="form-group mb-6">
            <input type="password" className="form-control block
              ...
              onChange={(e) => handleSetStudentData({...personalInfo, confirmPassword:e.target.value})}/>
          </div>
          <div className='p-5 mt-10 mb-5 bg-blue-50'>
            <h3 className="text-2xl leading-6 font-bold text-gray-900 mb-4">
              Cuestionario
        ...
        <div className="form-group mb-10 gap-2">
          <label htmlFor="degree" className="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-400 text-bold">Q09 Descríbete a ti mismo como generalmente eres ahora, no como deseas ser. Utilice la escala a continuación para calificar con qué precisión lo describe cada afirmación 1= No se parece en nada a mí, 2= no se parece mucho a mí, 3= se parece un poco a mí, 4= se parece bastante a mí, 5= se parece mucho a mí</label>
          {
            Q09OPTIONS.map((c) => (
