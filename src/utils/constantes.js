export const Q01OPTIONS = [
  ...
  export const Q03BOPTIONS = [
    ...
    export const COMPETENCIAS = [
      ...
      {id:"q06az",name:"Diseño y representación (Visual y Digital)",cal: 1},
    ...
    export const SKILLS = {
      ...
      "Diseño y Construcción": [
        {id:"c_sanitary_installations",name:"Instalaciones sanitarias",level: 1},
        {id:"c_electrical_installations",name:"Instalaciones eléctricas",level: 1},
  ...
  export const Q09OPTIONS = [
    ...
    {
      id: 'q09h',
      name: '8. A menudo olvido poner las cosas de vuela en su lugar'
    },
    {
      id: 'q09i',
